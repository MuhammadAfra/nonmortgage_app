...
@section('content')
    <form action="{{ url('master_suku_bunga') }}" method="POST">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-8">
                <input type="text" name="Suku_Bunga" class="form-control" placeholder="Suku Bunga" style="width: 300px; height: 30px;">
                @error('Suku_Bunga')
        ...
        <div class="row pb-3">
            ...
            <div class="input-group" style="width: 300px; height: 38px;">
                ...
                <input type="text" class="form-control number-separator" placeholder="Nilai Suku Bunga" name="Nilai_Suku_Bunga">
                </div>

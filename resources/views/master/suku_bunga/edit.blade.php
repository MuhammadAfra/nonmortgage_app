...
@section('content')
    <form action="{{ url('master_suku_bunga', $sukuBunga->id) }}" method="POST">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-8">
                <input type="text" name="Nilai_Suku_Bunga" value="{{ number_format($sukuBunga->Nilai_Suku_Bunga) }}" class="form-control number-separator" style="width: 300px; height: 30px;">

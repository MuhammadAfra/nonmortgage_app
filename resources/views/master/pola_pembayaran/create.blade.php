...
@section('content')
    <form action="{{ url('master_pola_pembayaran') }}" method="POST">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-8">
                <input type="text" name="Pola_Pembayaran" placeholder="Pola Pembayaran" class="form-control" style="width: 300px; height: 30px;">
        ...
        <div class="row pb-3">
            ...
            <div class="input-group" style="width: 300px; height: 38px;">
                ...
                <input type="text" class="form-control number-separator" placeholder="Nilai Pola Pembayaran" name="Nilai_Pola_Pembayaran">
                </div>

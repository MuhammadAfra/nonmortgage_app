...
@section('content')
    <form action="{{ url('product') }}" method="POST">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-8"><input type="number" name="id" class="form-control" style="width: 300px; height: 30px;"></div>
        </div>
        <div class="row pb-3">
            <div class="col-sm-4"><label>Partner ID</label></div>
            <div class="col-sm-8"><input type="number" name="PARTNER_ID" class="form-control" style="width: 300px; height: 30px;"></div>
        </div>
        <div class="row pb-3">
            <div class="col-sm-4"><label>Debitur ID</label></div>
            <div class="col-sm-8"><input type="number" name="DEBITUR_ID" class="form-control" style="width: 300px; height: 30px;"></div>
        </div>
        <div class="row pb-3">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-8"><input type="number" name="NILAI_PEMBIAYAAN_POKOK_MAXIMUM" class="form-control" style="width: 300px; height: 30px;"></div>
        </div>
        {{-- <div class="row pb-3">
            <div class="col-sm-4"><label>Partner ID</label></div>
            <div class="col-sm-8">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-8"><input type="number" name="Jangka_Waktu_Maximum" class="form-control" style="width: 300px; height: 30px;"></div>
        </div>
        {{-- <div class="row pb-3">

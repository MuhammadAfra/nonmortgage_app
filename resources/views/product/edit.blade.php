...
@section('content')
    <form action="{{ url('product', $dataproduct->id) }}" method="POST">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-8"><input type="text" name="NILAI_PEMBIAYAAN_POKOK_MAXIMUM" value="{{($dataproduct->NILAI_PEMBIAYAAN_POKOK_MAXIMUM) }}" class="form-control" style="width: 300px; height: 30px;"></div>
        </div>
        <div class="row pb-3">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-8"><input type="text" name="BIAYA_ADMINISTRASI" value="{{($dataproduct->BIAYA_ADMINISTRASI) }}" class="form-control " style="width: 300px; height: 30px;"></div>
        </div>
        <div class="row pb-3">
            <div class="col-sm-4"><label>Biaya Asuransi (Rp)</label></div>
            <div class="col-sm-8"><input type="text" name="BIAYA_ASSURANSI"  value="{{($dataproduct->BIAYA_ASSURANSI) }}" class="form-control " style="width: 300px; height: 30px;"></div>
        </div>
        <div class="row pb-3">
            <div class="col-sm-4"><label>Biaya Provisi (Rp)</label></div>
            <div class="col-sm-8"><input type="text" name="BIAYA_PROVISI" value="{{($dataproduct->BIAYA_PROVISI) }}" class="form-control " style="width: 300px; height: 30px;"></div>
        </div>
        <div class="row pb-3">
            <div class="col-sm-4"><label>Biaya Lain Lain (Rp)</label></div>
            <div class="col-sm-8"><input type="text" name="BIAYA_LAIN_LAIN" value="{{($dataproduct->BIAYA_LAIN_LAIN) }}" class="form-control " style="width: 300px; height: 30px;"></div>
        </div>
        <div class="row pb-3">

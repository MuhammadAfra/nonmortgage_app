...
<form action="{{ url('collateral_rumah', $rumah->id) }}" method="POST">
    ...
    <div class="row pb-3">
        ...
        <div class="col-sm-8">
            <input type="number" name="Nilai_Rumah_Tanah" value="{{ $rumah->Nilai_Rumah_Tanah }}" class="form-control" style="width: 300px; height: 30px;">
    ...
    <div class="row pb-3">
        ...
        <div class="col-sm-8">
            <input type="text" name="Nilai_Appraisal" value="{{ $rumah->Nilai_Appraisal }}" class="form-control" style="width: 300px; height: 30px;">

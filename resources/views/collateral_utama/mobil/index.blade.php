            ...
            <tbody>
                ...
                <tr >
                    ...
                    <td class="d-flex" style="justify-content: center">
                        <div><a href="{{ url('collateral_mobil/'.$item->id.'/edit') }}" class="btn btn-warning btn-sm text-white mr-1"><i class="fas fa-pen"></i></a></div>
                        <div><a href="{{ url('collateral_mobil/'.$item->id) }}" class="btn btn-info btn-sm text-white mr-1"><i class="fas fa-eye"></i></a></div>
                        <div>

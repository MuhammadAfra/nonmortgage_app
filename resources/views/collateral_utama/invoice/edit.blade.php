...
<form action="{{ url('collateral_invoice', $invoice->id) }}" method="POST">
    ...
    <div class="row pb-3">
        ...
        <div class="col-sm-4 d-flex">
            <div class="d-flex">
                <input type="radio" readonly value="PERORANGAN" style="width: 15px" name="debitur" {{ $invoice->jenisDeb == 'PERORANGAN' ? 'checked' : '' }} required class="form-control">
                <p class="my-auto mx-2" style="font-weight: 600">PERORANGAN</p>
            </div>
            <div class=" d-flex">
                <input type="radio" readonly value="BADAN_USAHA" style="width: 15px" name="debitur" {{ $invoice->jenisDeb == 'BADAN_USAHA' ? 'checked' : '' }} required class="form-control">
                ...
                <div class="row pb-3" >
                    ...
                    <div class="col-sm-8">
                        <select readonly name="DEBITUR_BADAN_USAHA_ID" id="DEBITUR_BADAN_USAHA_ID" class="form-control py-0 collCounterDebus" style="width: 300px; height: 30px;">
                            <option value="{{ $invoice->DEBITUR_BADAN_USAHA_ID }}">{{ $invoice->debitur_badan_usaha->NAMA_PERUSAHAAN }}</option>
                        </select>

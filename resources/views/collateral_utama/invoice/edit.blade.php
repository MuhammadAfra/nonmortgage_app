...
<form action="{{ url('collateral_invoice', $invoice->id) }}" method="POST">
    ...
    <div class="row pb-3">
        ...
        <div class="col-sm-8">
            <input type="number" name="Nilai_Invoice" value="{{ $invoice->Nilai_Invoice }}" class="form-control"
                style="width: 300px; height: 30px;">
            @error('Nilai_Invoice')
            <p class="text-danger">{{ $message }}</p>
            @enderror
    ...
    <div class="row pb-3">
        ...
        <div class="col-sm-8">
            <input type="text" name="Nilai_Fiducia" value="{{ $invoice->Nilai_Fiducia }}" class="form-control"
                style="width: 300px; height: 30px;">
            @error('Nilai_Fiducia')
            <p class="text-danger">{{ $message }}</p>
            @enderror

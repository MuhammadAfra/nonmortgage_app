...
<form action="{{ url('collateral_mobil_tambahan') }}" method="POST">
    ...
    <div class="row pb-3">
        ...
        <div class="col-sm-8">
            <input type="text" name="Nilai_Mobil_Vehicle_Tambahan" class="form-control number-separator" style="width: 300px; height: 30px;">
    ...
    <div class="row pb-3">
        ...
        <div class="col-sm-8">
            <input type="text" name="Peruntukan_Tambahan" class="form-control" style="width: 300px; height: 30px;">
            @error('Peruntukan')
            <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
    ...
    <div class="row pb-3">
        ...
        <div class="col-sm-8">
            <textarea name="Alamat_Di_Bpkb_Tambahan" style="width: 500px; height: 100px;" class="form-control" cols="30"
                rows="10"></textarea>
